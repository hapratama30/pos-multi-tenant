-- Migration 037: Add current_period_start to platform_list_tenants RPC return columns
...
COMMENT ON FUNCTION platform_list_tenants IS 'List platform tenants with current_period_start included';
